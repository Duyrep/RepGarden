...
export function DialogContent({
  ...
  return (
    <DialogPortal>
      <DialogOverlay className="data-[state=open]:animate-[fade-in_200ms] data-[state=closed]:animate-[fade-out_200ms]" />
      <RadixDialog.Content
        {...props}
        className="
          fixed p-10 top-0 right-0 w-screen h-dvh z-40 flex items-center justify-center duration-200
          data-[state=open]:animate-[fade-in_200ms] data-[state=closed]:animate-[fade-out_200ms]
        "
